...
5. **Read recent log entries** — Last 24-48h from `collalog/log.md` using awk: `awk '/^### (YYYY-MM-DD|YYYY-MM-DD)/,/^---$/' collalog/log.md` (substitute actual dates, NEVER read the whole file)
